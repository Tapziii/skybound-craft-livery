    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      <nav className="fixed top-0 w-full bg-white/90 backdrop-blur-md z-50 border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex justify-between items-center">
            <div className="text-2xl font-bold text-slate-800">SkyCanvas</div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center py-20">
            ...
            <h1 className="text-5xl md:text-7xl font-bold text-slate-800 mb-6 leading-tight">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-cyan-600"> Life</span>
            </h1>
      ...
      <section id="contact" className="py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <Card className="p-8 border-0 bg-slate-50">
      ...
      <footer className="bg-slate-800 text-white py-12 px-6">
        <div className="max-w-7xl mx-auto text-center">
          <div className="text-2xl font-bold mb-4">SkyCanvas</div>
          <p className="text-slate-400 mb-8">Professional Flight Simulator Liveries</p>
          <div className="border-t border-slate-700 pt-8">
            <p className="text-slate-400">© 2024 SkyCanvas. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
